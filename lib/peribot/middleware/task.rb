module Peribot
  module Middleware
    ...
    class Task
      ...
      # preprocessing and postprocessing, and feel free to use in sender tasks
      # if you are sure that the message has been sent properly and no other
      # senders will need it.
      #
